...
window.THINKING_ON_PAPER_CONFIG = {
  ...
  layouts: {
    landscape: {
      ...
      labels: { twoHairs: [1056, 244], wait: [1045, 354], question: [1062, 412], gap: [1062, 412], bridge: [1023, 552], transfer: [958, 655] }
    },
    portrait: {
      ...
      labels: { twoHairs: [88, 128], wait: [92, 420], question: [90, 478], gap: [90, 478], bridge: [86, 824], transfer: [88, 987] }
    }
  }
};
